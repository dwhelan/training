...
All numbers from `1` to `3999` could be formed by
counting multiples of 10 using the following mapping table:
...
Finally, `1984` has 1 thousand, 9 hundreds, 8 tens and 4 ones so it is 
